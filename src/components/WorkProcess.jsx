    ...
    <section className="relative py-16 lg:py-24 overflow-hidden" style={{
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="absolute left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-[#D89F30] via-[#F4B942] to-[#734918] hidden lg:block transform -translate-x-1/2"></div>
          ...
          <div className="space-y-12 lg:space-y-32">
            {processSteps.map((step, index) => (
              ...
              >
                {/* Step Content */}
                <div className={`flex-1 text-center lg:text-left ${index % 2 === 0 ? 'lg:pr-20' : 'lg:pl-20'}`}>
                  <div className="group">
                    {/* Step Number */}
                    <div className="inline-block mb-6 lg:mb-8">
                      <span className="luxury-title text-5xl lg:text-9xl leading-none" style={{
                    ...
                    {/* Step Title */}
                    <h3 className="luxury-nav text-[#D89F30] text-xl lg:text-4xl font-semibold mb-4 lg:mb-8 tracking-wide">
                      {step.title}
                    </h3>
                    
                    {/* Step Description */}
                    <p className="luxury-subtitle text-gray-200 leading-relaxed text-base lg:text-xl max-w-2xl mx-auto lg:mx-0 font-light tracking-wide">
                      {step.description}
                    </p>
                  </div>
                </div>
                ...
                <div className="relative flex-shrink-0">
                  {/* Icon Container */}
                  <div className="relative w-24 h-24 lg:w-40 lg:h-40 rounded-full flex items-center justify-center text-3xl lg:text-5xl shadow-2xl transition-all duration-700 group-hover:scale-110 group-hover:rotate-3"
                    style={{
                      background: `linear-gradient(135deg, ${step.color})`,
        ...
        <div className="text-center mt-16 lg:mt-24">
          <div className="inline-block p-8 lg:p-12 rounded-3xl" style={{
            ...
            <h3 className="luxury-title text-2xl lg:text-5xl mb-6 lg:mb-8">
              READY TO START YOUR JOURNEY?
            </h3>
            <p className="luxury-subtitle text-base lg:text-xl text-white mb-8 lg:mb-10 max-w-3xl mx-auto leading-relaxed font-light tracking-wide px-4 lg:px-0">
              Begin with a consultation and let us transform your cherished items into timeless treasures.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 lg:gap-6 justify-center">
              <button className="luxury-button bg-gradient-to-r from-[#D89F30] to-[#734918] text-white px-8 lg:px-12 py-3 lg:py-5 rounded-full text-base lg:text-xl font-semibold hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
                BOOK CONSULTATION
              </button>
              <button className="luxury-button border-2 border-[#D89F30] text-[#D89F30] px-8 lg:px-12 py-3 lg:py-5 rounded-full text-base lg:text-xl font-semibold hover:bg-[#D89F30] hover:text-white transition-all duration-300 hover:scale-105">
                LEARN MORE
              </button>
            </div>
          </div>
